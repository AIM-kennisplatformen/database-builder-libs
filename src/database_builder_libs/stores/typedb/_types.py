...
class EagerQueryAnswer:
    ...
    def __init__(self, answer: QueryAnswer):
        ...
        if self._is_docs:
            self._concept_documents = list(answer.as_concept_documents())
        elif self._is_rows:
            self._concept_rows = list(answer.as_concept_rows())
        else:
            self._answer = answer
    ...
    def as_concept_documents(self) -> Iterator:
        ...
        return iter(self._concept_documents)
    ...
    def as_concept_rows(self) -> Iterator:
        ...
        return iter(self._concept_rows)
