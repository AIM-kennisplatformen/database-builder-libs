...
1. If not already read, start with [Introduction page](../introduction/00_introduction.md) of the documentation. (5 minutes)
2. Read the [Main Modules](../main_modules/00_overview.md) pages to get a better understanding of the library. (30 minutes)